...
Run comprehensive RFC module quality checks in the standard test container through the chat interface.
...
Runs in the same container family used by this repository's CI:
...
| "Run all checks on src" | Full suite, scoped to RFC module sources |
