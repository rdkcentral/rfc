...
def test_rfc_override_dbg_srv_locked():
    ...
    try:
        ...
        # Capture only RFC logs generated by this rfcMgr invocation.
        log_before = read_rfc_log()
        ...
        assert default_url_msg in new_log, (
        ...
        assert persistent_msg not in new_log, (
            "RFC selected /opt/rfc.properties while "
            "debug services were locked"
        )

        assert override_msg not in new_log, (
